...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=20&duration=2600&pause=900&color=7DD3FC&center=true&vCenter=true&width=680&lines=Electronics+%26+Communication+Engineering%2C+VIT+Vellore;VLSI+%2F+RTL+%C2%B7+Analog+%26+PCB+%C2%B7+Embedded+Systems;IEEE+Circuits+%26+Systems+%E2%80%94+Secretary%2C+VIT" alt="Typing SVG" />
...
I'm pursuing a B.Tech in Electronics & Communication Engineering at VIT Vellore (CGPA 9.14/10, Class of 2027), working across VLSI/ASIC and RTL design, analog and PCB hardware, and embedded systems. My interest sits at the layer where a signal becomes a working circuit — from gate-level logic and IC tapeout flows to instrumentation-grade analog front-ends and firmware for real sensor systems. I'm also interested in hardware security, neuromorphic computing, and optical fiber communications.

Outside coursework, I serve as Secretary of IEEE Circuits and Systems (CAS) at VIT, organizing technical events and mentoring members in circuits, embedded systems, and PCB design. I've also worked in industrial settings — assembly-line maintenance and PLC automation at Toyota Kirloskar Motor, and industrial IoT / condition monitoring at Schneider Electric.

<div align="center">

<img src="https://img.shields.io/badge/CGPA-9.14%2F10-1e293b?style=flat-square" />
<img src="https://img.shields.io/badge/IEEE%20CAS-Secretary-1e293b?style=flat-square" />
<img src="https://img.shields.io/badge/Hackathons-6%C3%97%20Winner-1e293b?style=flat-square" />
<img src="https://img.shields.io/badge/Patent-Under%20Review-1e293b?style=flat-square" />
...
- **6× Hackathon Winner** — Hack-a-Tron Yantra'24, PCB Showdown Gravitas'24, ElectroHack Yantra'25, Electroutsav Hackathon, Hackulus Gravitas'25, Celestia Gravitas'25
...
- **Process improvement, Toyota Kirloskar Motor** — reduced control-panel fault-tracing time by 70% (20 min → 6 min) through Kaizen and 5-Why standardization
- **ASIC design selected for tape-out** — SKY130A, via the TinyTapeout program
- **Patent application** — currently under review
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1420,55:0c4a6e,100:0a0e17&height=90&section=footer" width="100%"/>
